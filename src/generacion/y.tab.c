...
static const yytype_int8 yytable[] =
{
      ...
      14,     0,     0,     0,    17,    11,    12,    13,    14,     0,
      15,    11,    12,    13,    14,     0,    22,    11,    12,    13,
      14
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* statement: IDENTIFIER EQUAL expression SEMICOLON  */
#line 19 "src/syntax.y"
                                              { process_assignment(yyvsp[-3], yyvsp[-1]); }
#line 1094 "src/generacion/y.tab.c"
    break;

  case 6: /* statement: expression SEMICOLON  */
#line 20 "src/syntax.y"
                                              { eval_expression(yyvsp[-1]); }
#line 1100 "src/generacion/y.tab.c"
    break;
